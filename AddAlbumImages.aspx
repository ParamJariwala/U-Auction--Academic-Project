<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddAlbumImages.aspx.cs" Inherits="Admin_AddAlbumImages" %>
    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Add Album Images</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList CssClass="form-control" ID="ddlalbum" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlalbum_SelectedIndexChanged">
                            ...
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table-responsive table table-striped table-bordered" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Image">
                                        ...
                                        <ItemTemplate>
                                            <img src='../<%# Eval("img") %>' alt ="Image" style="height:100px; width:200px;">
