...
<head runat="server">
  ...
  <title>I-Learn Website Admin Panel</title>
  <link rel="icon" href="plugins/images/favicon_final.png" sizes="32x32" />
      ...
      <form class="login-form" runat="server">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="plugins/images/logo_1024.jpg" alt="" class="circle responsive-img valign profile-image-login" />
            <p class="center login-form-text">I-Learn Admin Login</p>
          </div>
        </div>
