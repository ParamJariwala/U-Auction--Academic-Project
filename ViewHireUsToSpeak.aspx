<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewHireUsToSpeak.aspx.cs" Inherits="Admin_ViewHireUsToSpeak" %>
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table-responsive table table-striped table-bordered" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="Recommended Name" />
